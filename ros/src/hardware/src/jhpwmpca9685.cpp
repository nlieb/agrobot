#include <au_sensors/JHPWMPCA9685.h>
#include <math.h>
...
void PCA9685::setPulseLength(int channel, int usec) {
  float usecPerWave = 1000000.0 / (float)currentFrequency_;
  int offValue = (int)(usec / usecPerWave * 4095.0);
